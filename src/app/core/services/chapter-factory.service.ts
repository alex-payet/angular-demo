...
export class ChapterFactoryService {
  ...
  private build(): void {
    this.builder.create('Installation', 'Logiciels & Co.')
      .add('node', ['V8 : JavaScript open-source', 'Serveur web local'], false)
      .add('npm', ['Gestionnaire de paquet', 'npm install -g @angular/cli', 'npm -i <paquet>'])
      .add('angular-project', ['ng new <project-name>', 'ng generate ...'])
      .add('navigateur', ['Chrome', 'Chromuim', 'Edge', '.browserlist'], false)
      ...
      .flush()
      .create('Projet', 'Architecture')
      .add('project', ['node_modules', 'src/app', 'dist', 'assets'], false)
